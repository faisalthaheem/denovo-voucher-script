			<?php	
				if(isset($widget_category_link_sites_result) && !$widget_category_link_sites_result)
				{
			?>
			...
			<?php
				...
				else if(isset($widget_category_link_sites_result) && $widget_category_link_sites_result)
				{
			?>
			<div class="listItem-container">
			<table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
					...
					<td colspan="2">
						<?php
								echo $this->Js->submit(__('Create Link',true), array(
											'url' => "/{$this->params['prefix']}/categories/widget_category_lnk_to_site",
											'method'=> 'post',
