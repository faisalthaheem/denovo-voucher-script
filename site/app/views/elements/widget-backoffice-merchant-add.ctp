<div class="siteSetting-widget-container">
	...
	<div class="content2-widget-container">
		...
		<div class="detail">
			...
			<?php
				if(isset($widget_merchant_add_result) && !$widget_merchant_add_result){
			?>
			...
			<?php
				...
				else if(isset($widget_merchant_add_result) && $widget_merchant_add_result)
				{
			?>
				<script> 
					...
					<td colspan="3">
						<?php
								echo $this->Js->submit(__('Create',true), 
										array(
											'url' => "/{$this->params['prefix']}/merchants/widget_merchants_add/{$container}",
											'method'=> 'post',
											'update' => '#widget-main-mid-bottom-container',
											'div' => false,
											'class' => 'btn',
											'id' => 'btnCreateMerchant'
											)
									); 
								
								echo $this->Html->link(__('Cancel',true), 
													'javascript:void(0);', 
													array('id' => 'lnk-widget-merchant-add-cancel',
														'class' => 'btn')); 
						?>
					</td>
				</tr>
			...
			<script>
				$(document).ready(function() {
					...
					$("#lnk-widget-merchant-add-cancel").click(function(){
			...
			<?php
				...
				echo $this->element('widget-backoffice-check-name-exists',
									array(
											...
											'RecordId' => $RecordID,
											'SubmitButtonId' => 'btnCreateMerchant'
											)
										);
