...
<?php 
		if(isset($result_widget_site_edit) && $result_widget_site_edit = true){
?>
	<script>
	...
	<div class="content2-widget-container">
		...
		<div class="detail">
			...
			<?php
					...
					if(isset($logo['Picture']['uuidtag'])){
						$imageTag = $logo['Picture']['uuidtag'];
						$imagefilename = $logo['Picture']['filename'];
					}
			...
			<table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
				...
				<tr>
					...
					<td colspan="2">
						...
						<?php echo $this->Form->input('logopath', array('type' => 'hidden', 'value' => $imageTag, 'id' => 'uuid-hidden-field'));?>
					</td>
				</tr>
					...
					<td colspan="3">
						<?php
							echo $this->Js->submit(__('UPDATE',true),
								array(
									'url' => '/'.$this->params["prefix"].'/sites/edit/',
									'method'=> 'post',
							...
							echo $this->Html->link(__('Cancel',true), 
													'javascript:void(0);',
													array('id' => 'lnk-widget-site-edit-cancel',
															'class' => 'btn')); 
			...
			<script>
				$(document).ready(function() {
					...
					$("#lnk-widget-site-edit-cancel").click(function(){
						$("#widget-main-mid-bottom-container").html('');
					});
				});
			</script>
