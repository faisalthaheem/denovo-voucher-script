	<?php	
		if(isset($widget_cod_unlink_sites_result) && !$widget_cod_unlink_sites_result)
		{
	?>
	...
	<?php
		...
		else if(isset($widget_cod_unlink_sites_result) && $widget_cod_unlink_sites_result)
		{
	?>
		<div class="listItem-container">
			<table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
					...
					<td colspan="2">
						<?php
							echo $this->Js->submit(__('Unlink',true), array(
										'url' => "/{$this->params['prefix']}/cods/widget_cods_just_unlink",
										'method'=> 'post',
