	...
	<div class="siteSetting-widget-container">
 		...
 		<div class="content2-widget-container">
        	<div class="title">
            	<div class="txt"><?php __('Update News');?> &raquo;</div>
            </div>
            
            <div class="detail">
				<?php	
					if(isset($widget_news_edit_result) && !$widget_news_edit_result)
					{
				?>
				...
				<?php
					...
					else if(isset($widget_news_edit_result) && $widget_news_edit_result)
					{
				?>
						...
						<td colspan="3">
							<?php
								echo $this->Js->submit(__('Update',true), array(
											'url' => "/{$this->params['prefix']}/news/edit/",
											'method'=> 'post',
								...
								echo $this->Html->link(__('Cancel',true), 'javascript:void(0);', 
													array('id' => 'lnk-widget-news-edit-cancel',
														'class' => 'btn')); 
							?>
						</td>
					</tr>
		...
		<script>
			$(document).ready(function() {
				...
				$("#lnk-widget-news-edit-cancel").click(function(){
					$("#widget-main-mid-bottom-container").empty();
				});
			});
		</script>			
