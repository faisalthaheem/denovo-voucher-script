	<?php	
		if(isset($widget_single_cod_link_sites_result) && !$widget_single_cod_link_sites_result)
		{
	?>
	...
	<?php
		...
		else if(isset($widget_single_cod_link_sites_result) && $widget_single_cod_link_sites_result)
		{
	?>
		<div class="listItem-container">
			<table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
				...
				<tr>
					...
					<td colspan="2">
           			<?php 
						...
						echo $this->Form->input('id', array('type' => 'hidden', 'value' => $codId)); 
					?>	                        
					</td>
				</tr>
				<tr>
					...
					<td colspan="2">
						<?php
								echo $this->Js->submit(__('Link',true), array(
											'url' => "/{$this->params['prefix']}/cods/widget_single_cod_lnk_to_site",
											'method'=> 'post',
