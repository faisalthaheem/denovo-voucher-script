<div class="siteSetting-widget-container">
	<div class="content2-widget-container">
		...
		<div class="title">
	    	<div class="txt">Affilinet Settings &raquo;</div>
		</div>
	    ...
	    <div class="detail">
			...
			<table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
	            ...
	            <tr>
	            	<td>Affilinet User ID</td>
	                <td colspan="2">
	                	<?php 
	                		echo $this->Form->input('userid', array('class' => 'input-field-large'));
	                	?>
	                </td>
				</tr>
	            
	            <tr>
	            	<td>Affilinet Password</td>
					<td colspan="2">
	                	<?php 
	                		echo $this->Form->input('code', array('class' => 'input-field-large'));
	                	?>
					</td>
				</tr>
	
	            <tr>
	            	<td>Affilinet Publisher ID</td>
					<td colspan="2">
	                	<?php 
	                		echo $this->Form->input('publisherid', array('class' => 'input-field-large'));
	                	?>
					</td>
				</tr>
	            ...
	            <tr>
					...
					<?php
							echo $this->Js->submit('UPDATE',
								array(
									'url' => '/'.$this->params['prefix'].'/dvs4affilinet/configuration/configure/',
									'method'=> 'post',
