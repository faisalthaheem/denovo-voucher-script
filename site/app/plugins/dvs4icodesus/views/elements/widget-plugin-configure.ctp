<div class="siteSetting-widget-container">
	<div class="content2-widget-container">
		<div class="title">
	    	<div class="txt">IcodesUS Settings &raquo;</div>
		</div>
	    ...
	    <div class="detail">
			...
			<table width="600" border="0" cellpadding="0" cellspacing="0" align="center">
	            ...
	            <tr>
	            	<td>IcodesUS Subscription ID:</td>
					<td colspan="2">
	                	<?php 
	            ...
	            <tr>
					...
					<?php
							echo $this->Js->submit('UPDATE',
								array(
									'url' => '/'.$this->params["prefix"].'/dvs4icodesus/configuration/configure/',
									'method'=> 'post',
