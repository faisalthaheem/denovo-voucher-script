...
<div id="dvs4icodesus-merchants-map-content-container">
...
<script>
	jQuery(document).ready(function(){
		...
		jQuery( "#mapping_filter_btn" ).button().click(function(){
			...
			jQuery.get('/admin/dvs4icodesus/icodesus_merchants/mappingfilter/' + jQuery("input[name='mapping_filter']:checked", '#mapping_filter_form').val(), function(data){
				jQuery.get('/admin/dvs4icodesus/icodesus_merchants/map_content', function(data){
					jQuery("#dvs4icodesus-merchants-map-content-container").html(data);
				});				
			});
