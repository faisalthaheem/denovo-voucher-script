...
class ConfigurationController extends Dvs4icodesusAppController {
	...
	function admin_configure()
	{
		...
		if(!empty($this->data))
		{
			...
			$result = 'IcodesUS Service credentials updated successfully.';
		}
		else
		{
			$result = 'IcodesUS Service credentials Settings';
		}
	...
	function manager_configure()
	{
		...
		{
			$result = 'IcodesUK Service credentials Settings';
		}
